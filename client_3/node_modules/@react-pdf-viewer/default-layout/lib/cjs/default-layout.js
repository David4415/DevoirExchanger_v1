...
var Sidebar = function (_a) {
    ...
    return (React__namespace.createElement("div", { className: "rpv-default-layout__sidebar " + (opened ? 'rpv-default-layout__sidebar--opened' : '') },
        React__namespace.createElement("div", { className: "rpv-default-layout__sidebar-tabs" },
            React__namespace.createElement("div", { className: "rpv-default-layout__sidebar-headers" }, listTabs.map(function (tab, index) { return (React__namespace.createElement("div", { key: index, className: "rpv-default-layout__sidebar-header" },
                React__namespace.createElement(core.Tooltip, { position: core.Position.RightCenter, target: React__namespace.createElement(core.MinimalButton, { onClick: function () { return switchToTab(index); }, isSelected: currentTab === index }, tab.icon), content: function () { return tab.title; }, offset: TOOLTIP_OFFSET }))); })),
            React__namespace.createElement("div", { className: "rpv-default-layout__sidebar-content " + (opened ? 'rpv-default-layout__sidebar-content--opened' : '') }, listTabs[currentTab].content))));
};
